...
function HeroSection() {
  return (
    ...
    <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center hero-main-cont">
     ...
     <div className="hero-head1">
        <h1 class="title-font sm:text-4xl text-3xl mb-1 font-medium text-gray-700 text-center">  <img src="383.png" className="pokemon-ball"/> GROUDON INU</h1> <p class="mb-2 leading-relaxed text-center">Continent Pokemon</p> </div>
  ...
  <path d="M14 4.577v6.846L8 15l-6-3.577V4.577L8 1l6 3.577zM8.5.134a1 1 0 0 0-1 0l-6 3.577a1 1 0 0 0-.5.866v6.846a1 1 0 0 0 .5.866l6 3.577a1 1 0 0 0 1 0l6-3.577a1 1 0 0 0 .5-.866V4.577a1 1 0 0 0-.5-.866L8.5.134z"/>
            ...
            <span class="ml-4 flex items-start flex-col leading-none">
              <span class="title-font font-medium">WT  -  2094 lbs</span>
            </span>
          </button>
          </div>
          <Link to='/buy' > 
    ...
    <div class="hero-head2 mt-3">Groudon Inu is said to be the personification of the land itself. Legends tell of its many clashes against Kyogre, as each sought to gain the power of nature. Through Primal Reversion and with nature's full power, it will take back its true form. It can cause magma to erupt and expand the landmass of the world.</div> 
  </section>
  </>
  );
}
