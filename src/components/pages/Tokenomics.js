...
>
  ...
  />
          ...
          <span class="title-font font-medium">10% Buy/Sell Tax</span>
        </div>
      </div>
      <div class="p-2 sm:w-1/2 w-full">
        <div class="bg-gray-100 rounded flex p-4 h-full items-center">
...
>
  ...
  />
          ...
          <span class="title-font font-medium">100,000,000,000,000 $GROU Tokens</span>
        </div>
        </div>
 </div>
    <button class="flex mx-auto mt-16  rounded  text-white bg-red-500"> <Link
                to='/buy'
